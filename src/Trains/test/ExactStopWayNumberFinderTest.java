 ...
 */
public class ExactStopWayNumberFinderTest {
    private ExactStopWayNumberFinder finder;
    ...
    public void test_findWayNumber_can_return() {
        finder = new ExactStopWayNumberFinder(null);
    ...
    public void test_findWayNumber_can_find_only_one_route_within_limited() {
        ...
        finder = new ExactStopWayNumberFinder(routeMap);
    ...
    public void test_findWayNumber_can_find_only_one_route_without_limited() {
        ...
        assertEquals(ExactStopWayNumberFinder.NO_WAY_FIND, wayNumber);
    }
